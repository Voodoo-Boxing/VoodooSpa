...
export default function NavBar() {
  ...
  return (
    <Disclosure
      as="nav"
      className="relative bg-[var(--voodoo-black)] after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10"
    >
                ...
                {NAVIGATION.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current
                        ? "bg-[var(--voodoo-purple-05)] text-white"
